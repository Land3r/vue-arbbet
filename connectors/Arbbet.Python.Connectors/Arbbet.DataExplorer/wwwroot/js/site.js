...
jQuery(document).ready(function () {
    ...
    /* Disabled fix */
    jQuery(document).on("click", "a.disabled,a:disabled", function (e) {
        return false;
    });

    jQuery(".input-group-password-toggle .input-group-append").on('click', function () {
        console.log('called')
        let input = jQuery(this).siblings('input.form-control');
        let type = input?.attr('type');

        if (type === 'password') {
            jQuery(this).find('.input-group-text').html('<i class="far fa-eye"></i>');
            input.attr('type', 'text');
        }
        else if (type === 'text') {
            jQuery(this).find('.input-group-text').html('<i class="far fa-eye-slash"></i>');
...
/***** dashgrin function start *****/
var dashgrin = function () {

    // TODO: Il y aura une procédure de nettoyage à prévoir des librairies utilisées de celles non utilisées.
    ...
    $(document).on('click', '#nav_light_select,#nav_dark_select', function (e) {
        $('.hk-nav-select').find('.btn').removeClass('btn-outline-success').addClass('btn-outline-light');
        $(this).removeClass('btn-outline-light').addClass('btn-outline-success').blur();
        return false;
    });
    $(document).on('click', '#navtop_light_select,#navtop_dark_select', function (e) {
        $('.hk-navbar-select').find('.btn').removeClass('btn-outline-success').addClass('btn-outline-light');
        $(this).removeClass('btn-outline-light').addClass('btn-outline-success').blur();
        return false;
    });
